...
public class InternalMavenPlugin implements Plugin<Project> {
    ...
    @Inject
    public InternalMavenPlugin(InstantiatorFactory instantiatorFactory, ObjectFactory objectFactory, DependencyMetaDataProvider dependencyMetaDataProvider, FileResolver fileResolver, ImmutableAttributesFactory immutableAttributesFactory, ProviderFactory providerFactory) {
    ...
    public void apply(final Project project) {
        project.getPluginManager().apply(InternalPublishPlugin.class);

        project.getExtensions().configure(InternalPublishExtension.class, extension -> {
    ...
    private void realizePublishingTasksLater(final Project project, final InternalPublishExtension extension) {
